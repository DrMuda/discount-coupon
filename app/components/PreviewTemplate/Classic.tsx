import ClassicStyle from './Classic.css';
import { type TColorType } from '~/components/Setting';
...
export default function Classic({
  ...
  codeColor = '#000000',
  textColor = '#000000',
  leftText = 'Buy AED 4.00,AED 2.00 OFF',
}: Record<TColorType, string | undefined> & {
  ...
  return (
    <div
      ...
      className={`classic ${previewDevice}`}
    >
      <svg width="0" height="0">
        ...
        >
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M12 0H0V12H3V9.93812C6.61877 9.48692 9.48697 6.61876 9.93823 3H12V0ZM6 4C6 5.10457 5.10457 6 4 6C2.89543 6 2 5.10457 2 4C2 2.89543 2.89543 2 4 2C5.10457 2 6 2.89543 6 4Z"
            fill="currentColor"
          ></path>
        </symbol>
        ...
        >
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M8 0H0V2H3C3 4.76143 5.23859 7 8 7V0Z"
            fill="currentColor"
          ></path>
        </symbol>
      </svg>
      ...
      <svg
        ...
        height="12"
        style={{ backgroundColor: codeBgColor }}
        className="lt big-corner"
      >
        <use xlinkHref="#leftTopBigCorner" />
      </svg>
      <svg
        width="12"
        height="12"
        style={{ backgroundColor: codeBgColor }}
        className="rt big-corner"
      >
        <use xlinkHref="#leftTopBigCorner" />
      </svg>
      <svg
      ...
      <svg
        ...
        height="12"
        style={{ backgroundColor: codeBgColor }}
        className="rb big-corner"
      >
        <use xlinkHref="#leftTopBigCorner" />
      </svg>

      {/* 用于把容器自动撑高 */}
      <div className="left-content height-content">
      ...
      <div className="divider">
        <svg width="8" height="8" className="rt small-corner">
          <use xlinkHref="#rightTopSmallCorner" />
        </svg>
        <svg width="8" height="8" className="rb small-corner">
          <use xlinkHref="#rightTopSmallCorner" />
        </svg>
        <svg width="8" height="8" className="lt small-corner">
          <use xlinkHref="#rightTopSmallCorner" />
        </svg>
        <svg width="8" height="8" className="lb small-corner">
          <use xlinkHref="#rightTopSmallCorner" />
        </svg>
      </div>
